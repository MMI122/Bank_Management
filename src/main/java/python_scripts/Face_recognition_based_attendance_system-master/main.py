...
def check_haarcascadefile():
    exists = os.path.isfile("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/haarcascade_frontalface_default.xml")
    if exists:
        pass
    else:
...
def save_pass():
    ...
    exists1 = os.path.isfile("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/psd.txt")
    if exists1:
        tf = open("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/psd.txt", "r")
        key = tf.read()
    else:
        master.destroy()
        ...
        if new_pas == None:
            ...
            tf = open("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/psd.txt", "w")
            tf.write(new_pas)
    ...
    if (op == key):
        if(newp == nnewp):
            txf = open("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/psd.txt", "w")
            txf.write(newp)
        else:
...
def TakeImages():
    ...
    serial = 0
    exists = os.path.isfile("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv")
    if exists:
        with open("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv", 'r') as csvFile1:
        ...
        with open("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv", 'a+') as csvFile1:
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = "src/main/java/python_scripts/Face_recognition_based_attendance_system-master/haarcascade_frontalface_default.xml"
        ...
        row = [serial, '', Id, '', name]
        with open('src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def TrainImages():
    ...
    try:
        ...
        return
    recognizer.save("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/Trainner.yml")
...
def TrackImages():
    ...
    exists3 = os.path.isfile("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/Trainner.yml")
    if exists3:
        recognizer.read("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/TrainingImageLabel/Trainner.yml")
    else:
    ...
    exists1 = os.path.isfile("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv")
    if exists1:
        df = pd.read_csv("src/main/java/python_scripts/Face_recognition_based_attendance_system-master/StudentDetails/StudentDetails.csv")
    else:
